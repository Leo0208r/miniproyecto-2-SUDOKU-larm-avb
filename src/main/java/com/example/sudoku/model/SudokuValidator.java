...
public class SudokuValidator implements IValidator {
     ...
     */
    @Override
    public boolean isValidate(SudokuBoard board, int row, int column, int value) {
     ...
     */
    @Override
    public boolean isRow(SudokuBoard board, int row, int value) {
     ...
     */
    @Override
    public boolean isColumn(SudokuBoard board, int column, int value) {
     ...
     */
    @Override
    public boolean isBlock(SudokuBoard board, int row, int column, int value) {
